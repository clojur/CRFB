...
IMPLEMENT_SERIAL(CBarHSteelBar, CBarSteelBar, 0);
CBarHSteelBar::CBarHSteelBar()
{
	m_BarType = CBarSteelBar::H;
}


CBarHSteelBar::CBarHSteelBar(CMainGirder* gdrL, CMainGirder* gdrR, int segL, int segR) :CBarSteelBar(gdrL, gdrR, segL, segR)
{
	m_BarType = CBarSteelBar::H;
}
...
void CBarHSteelBar::createPtArray()
{
...
void CBarHSteelBar::Serialize(CArchive &ar)
{
	if (ar.IsStoring())
	{
